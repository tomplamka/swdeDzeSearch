...
# translation
SOURCES = swdedzesearch.py ui_swdedzesearch.py __init__.py swdedzesearchdialog.py
#TRANSLATIONS = i18n/swdedzesearch_en.ts
TRANSLATIONS = 

# global

PLUGINNAME = swdedzesearch

PY_FILES = swdedzesearch.py swdedzesearchdialog.py __init__.py

EXTRAS = icon.png 

UI_FILES = ui_swdedzesearch.py
